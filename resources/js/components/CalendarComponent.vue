<template>
  <div class="container">
    <div class="row justify-content-center">
      ...
      <div class="col-md-8">
        <Fullcalendar @eventClick="showEvent" :plugins="calendarPlugins" :events="events" schedulerLicenseKey="GPL-My-Project-Is-Open-Source"/>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      calendarPlugins: [dayGridPlugin, interactionPlugin,resourceTimelinePlugin],
      events: "",
      errors: "",
      newEvent: {
        event_name: "",
